...
export default function BIMPage() {
  ...
  const [filterStatus, setFilterStatus] = useState<BIMElementStatus | "all">(
    "all",
  );
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {
                              levels.find((l) => l.value === element.level)
                                ?.label
                            }{" "}
                            • GUID: {element.guid.slice(0, 8)}...
                          </p>
                        </div>
                      </div>
                      <span
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between py-2 border-b border-border">
                  ...
                  <span className="font-medium">
                    {
                      elementTypes.find((t) => t.value === selectedElement.type)
                        ?.label
                    }
                  </span>
                </div>
                <div className="flex justify-between py-2 border-b border-border">
                  ...
                  <span className="font-medium">
                    {
                      levels.find((l) => l.value === selectedElement.level)
                        ?.label
                    }
                  </span>
                </div>
                <div className="flex justify-between py-2 border-b border-border">
                  ...
                  <span className="font-medium">
                    {new Date(selectedElement.plannedStart).toLocaleDateString(
                      "pt-BR",
                    )}
                  </span>
                </div>
                <div className="flex justify-between py-2 border-b border-border">
                  ...
                  <span className="font-medium">
                    {new Date(selectedElement.plannedEnd).toLocaleDateString(
                      "pt-BR",
                    )}
                  </span>
                </div>
                ...
                <div
                  className={cn(
                    ...
                    selectedElement.status === "completed"
                      ? "bg-success"
                      : selectedElement.status === "delayed"
                        ? "bg-destructive"
